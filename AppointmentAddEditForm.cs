    ...
    public partial class AppointmentAddEditForm : Form
    {
        ...
        private void saveButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if(appt.Start <= selectedStart && appt.End > selectedStart && (!(SelectedAppointmentID >= 0)) || SelectedAppointmentID >= 0)
                    {
                        overlaping = true;
                    }

                    if (selectedStart <= appt.Start && selectedEnd > appt.Start && (!(SelectedAppointmentID >= 0)) || SelectedAppointmentID >= 0)
                    {
                        overlaping = true;
                    }
                }
